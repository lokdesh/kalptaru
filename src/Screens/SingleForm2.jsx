  ...
  return (
    <View style={styles.container}>
      <View style={styles.heading}>
        ...
        <Text style={styles.headingText}>Annexure 2 </Text>
      </View>
      <ScrollView horizontal={true} style={styles.table}>
        <View>
          ...
          <View style={styles.tableHead}>
            ...
            <Text style={styles.tableHeadText}>Name Of Officer</Text>
            <Text style={styles.tableHeadText}>Phone Of Officer</Text>
            ...
            <Text style={styles.tableHeadText}>Date Of Traning</Text>
            <Text style={styles.tableHeadText}>Village Scheme</Text>
            <Text style={styles.tableHeadText}>Checkbox</Text>
            <Text style={styles.tableHeadText}>No. of Participants</Text>
          ...
          {forms.map((item, index) => {
            return (
              <View style={styles.tableBody} key={index}>
                ...
                <Text style={styles.tableHeadText}>{item.nameOfOfficer}</Text>
                <Text style={styles.tableHeadText}>{item.phoneOfOfficer}</Text>
                ...
                <Text style={styles.tableHeadText}>{item.dateOfTraning}</Text>
                <Text style={styles.tableHeadText}>{item.villageScheme}</Text>
                ...
                {item.image ? (
                  <Image
                    source={{ uri: `data:image;base64,${item.image}` }}
